...
description: "Configure DayTrader 7 runtime mode (EJB3 vs Direct JDBC), order processing mode (Sync vs Async), and other runtime parameters via the configuration servlet."
---
...
| `percentSentToWebsocket` | `5` (percent) | Percentage of quote price-change notifications that are actually forwarded to WebSocket sessions. Reducing this value lowers WebSocket overhead without disabling the feature entirely. |

...
description: "Deploy DayTrader 7 to Kubernetes or OpenShift using the OpenLiberty Operator, a DB2 backend, and the five YAML manifests in the repo's deploy/ directory."
---

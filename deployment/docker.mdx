---
title: "Run DayTrader 7 in a Docker Container with DB2"
sidebarTitle: "Docker"
description: "Containerize DayTrader 7 using the provided Containerfile with IBM WebSphere Liberty and a DB2 database backend."
---

---
title: "Quickstart: Run DayTrader 7 Locally on Open Liberty"
sidebarTitle: "Quickstart"
description: "Build and run DayTrader 7 locally on Open Liberty with an embedded Apache Derby database in minutes using Maven — no manual server install required."
---
